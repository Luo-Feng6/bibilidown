...
- 🐛 **浏览器模式 CDN 下载修复** — Vite 下载代理绕过 B站 CDN (Akamai) 防盗链，恢复浏览器端下载功能
- 🎨 **warning-bg token 修复** — `--color-warning-bg` 从灰色恢复为琥珀色（影响 6 个组件：弹窗/横幅/Toast 等）
- 🎨 **下载弹窗图标主题色** — ChoiceButton 图标从灰色改为主题蓝，与单流模式统一
